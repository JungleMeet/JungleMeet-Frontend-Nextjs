const ThumbsUp = () : JSX.Element => {
    return (
	 ...
	 width="14.643px" height="15.333px" viewBox="0 0 14.643 15.333" enableBackground="new 0 0 14.643 15.333" >
            <path fill="#E11D48" stroke="#000000" strokeLinejoin="round" d="M11.719,13.713l1.902-6.729c0.105-0.377-0.115-0.769-0.493-0.875
