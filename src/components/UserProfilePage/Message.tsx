...
const Message = ({setIsLoading}: IMessage) => {
    ...
    return (
        <MessageContainer>
            <Text fontSize="text5" lineHeight="lh32" fontWeight='500' position="relative"
                _after={{
                    content: '""',
                    width: '100%',
            ...
            ))}
            {
                currentPageNotice.length > 0 
                    ?
                    <Button onClick={handleClick} color='gray.500' lineHeight="lh16" fontWeight='700' fontFamily="secondary" fontSize="text4">Next</Button>
                    :
                    <Text color='gray.500' lineHeight="lh16" fontWeight='700' fontFamily="secondary" fontSize="text4" pt='20px' pb='30px'>No more notifications</Text>
            }
        </MessageContainer>
    )
};
