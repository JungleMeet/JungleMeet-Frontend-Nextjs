export const discussionsDate: {
...
}[] = [
    {
        ...
        comments: 9,
        content:
      "As a standalone film, “Dune” is a cinematic odyssey that will be remembered for decades. For the Avengers-level euphoria surrounding the film, its extraordinary cinematography, hauntingly beautiful score and outstanding performances, it deserves to be seen on the biggest. As a standalone film, “Dune” is a cinematic odyssey that will be remembered for decades. For the Avengers-level euphoria surrounding the film, its extraordinary cinematography, hauntingly beautiful score and outstanding performances, it deserves to be seen on the biggest...",
    },
    {
        id: 2,
        image: "/dune-discussion.jpg",
