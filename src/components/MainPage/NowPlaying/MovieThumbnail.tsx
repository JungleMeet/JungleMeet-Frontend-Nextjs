...
const MovieThumbnail = ({ id, src, title, tmdb, youtubeLink }: IMovieThumbnailProps): JSX.Element => {
    ...
    return (
        <Box pos="relative" height="436px" width="194px" bg="rgba(0, 0, 0, 0.9)" borderRadius="5px">
            {/* <Link href={`/movies/${id}`}> */}
            <Image src={src} width="194px" height="277px" objectFit="fill" cursor="pointer" onClick={()=> {
