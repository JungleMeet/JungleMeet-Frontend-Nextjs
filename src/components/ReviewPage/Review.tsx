...
const Review = () =>{
    ...
    return(
        <Grid>
            {commentsMemo?.map(({_id, author,createdAt,content,likeCount,mentionedUserId}:IReviewProps)=>{
                return(
                    <>
                        <Stack bg="gray.200" pb="46px" mb="32px" key={_id}>
                            ...
                            <Stack pl="100px" pt="-50px">
                                <Text>{content}</Text>
                                <Button size="sl" color="blue.500" fontSize={"text5"} width="50px" variant="unstyled">
                                    REPLY
                                </Button>
                            </Stack>
                            <Stack pl="106px" pb="32px">
                                ...
                                <Stack pl="48.75px" key={mentionedUserId}>
                                    ...
                                    <Button size="sl" color="blue.500" fontSize={"text5"} width="250px" variant="unstyled" pt="15px">
